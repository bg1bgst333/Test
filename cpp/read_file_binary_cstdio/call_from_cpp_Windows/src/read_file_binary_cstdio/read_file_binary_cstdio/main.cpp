...
int main(){
	...
	int ret1 = read_file_binary_cstdio("test1.txt", buf1, file_size_1 + 1);	// read_file_binary_cstdioで"test1.txt"を読み込み.
	...
	int ret2 = read_file_binary_cstdio("test2.txt", buf2, file_size_2 + 1);	// read_file_binary_cstdioで"test2.txt"を読み込み.
