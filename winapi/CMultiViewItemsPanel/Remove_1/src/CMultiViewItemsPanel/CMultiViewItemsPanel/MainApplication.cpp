...
BOOL CMainApplication::InitInstance(HINSTANCE hInstance, LPTSTR lpCmdLine, int nShowCmd) {
	...
	CWindowListView::RegisterClass(hInstance, m_hBrush1);	// CWindowListViewの登録.
	...
	CMultiViewItemsPanel::RegisterClass(hInstance, m_hBrush1);	// CMultiViewItemsPanelの登録.
	...
	CMultiViewItem::RegisterClass(hInstance);	// CMultiViewItemの登録.
	...
	// ウィンドウの作成.
	if (!pMainWnd->CreateEx(WS_EX_COMPOSITED, _T("CMultiViewItemsPanel"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance)) {	// m_pMainWnd->CreateExでウィンドウ作成し, 失敗した場合.
