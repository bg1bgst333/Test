...
int CMainWindow::OnCreate(HWND hwnd, LPCREATESTRUCT lpCreateStruct) {
	...
	// アイテムの挿入.
	m_pWindowListView->m_pMultiViewItemsPanel->Insert(0, _T("Item1"), _T("Item1"), 50, 50, 100, 100, m_hInstance);
	m_pWindowListView->m_pMultiViewItemsPanel->Insert(1, _T("Item2"), _T("Item2"), 160, 50, 100, 100, m_hInstance);
	m_pWindowListView->m_pMultiViewItemsPanel->Insert(1, _T("Item3"), _T("Item3"), 270, 50, 100, 100, m_hInstance);
	// アイテムの順番をデバッグ確認.
	...
	OutputDebugString(_T("\n"));
	// アイテムの削除.
	m_pWindowListView->m_pMultiViewItemsPanel->Delete(0);
	// アイテムの順番をデバッグ確認.
	OutputDebugString(m_pWindowListView->m_pMultiViewItemsPanel->Get(0)->m_tstrKey.c_str());
	OutputDebugString(_T("\n"));
	OutputDebugString(m_pWindowListView->m_pMultiViewItemsPanel->Get(1)->m_tstrKey.c_str());
