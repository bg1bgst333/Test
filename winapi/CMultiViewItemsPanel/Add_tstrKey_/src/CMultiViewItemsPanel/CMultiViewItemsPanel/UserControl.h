...
class CUserControl : public CWindow {
	...
	public:
		...
		static BOOL RegisterClass(HINSTANCE hInstance, LPCTSTR lpctszClassName, int i);	// ウィンドウクラス登録関数RegisterClass(背景色指定バージョン.)
		static BOOL RegisterClass(HINSTANCE hInstance, LPCTSTR lpctszClassName, HBRUSH hbrBackground);	// ウィンドウクラス登録関数RegisterClass(背景ブラシハンドル指定バージョン.)
		// メンバ関数
