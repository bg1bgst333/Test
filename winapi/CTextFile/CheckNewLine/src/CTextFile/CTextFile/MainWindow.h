...
class CMainWindow : public CWindow{
	...
	public:
		...
		int OnItem1_5(WPARAM wParam, LPARAM lParam);	// Item1-5が選択された時.
		int OnItem1_6(WPARAM wParam, LPARAM lParam);	// Item1-6が選択された時.
		int OnItem1_7(WPARAM wParam, LPARAM lParam);	// Item1-7が選択された時.
		int OnItem2_1(WPARAM wParam, LPARAM lParam);	// Item2-1が選択された時.
		int OnItem2_2(WPARAM wParam, LPARAM lParam);	// Item2-2が選択された時.
