...
class CMainWindow : public CWindow {
	...
	public:
		...
		int OnBomUtf8(WPARAM wParam, LPARAM lParam);	// UTF-8 BOMが選択された時.
		...
		int OnEncodeEucJp(WPARAM wParam, LPARAM lParam);	// EUC-JPが選択された時.
		int OnEncodeJis(WPARAM wParam, LPARAM lParam);	// JISが選択された時.
		...
		int OnItem3_1(WPARAM wParam, LPARAM lParam);	// Item3-1が選択された時.
