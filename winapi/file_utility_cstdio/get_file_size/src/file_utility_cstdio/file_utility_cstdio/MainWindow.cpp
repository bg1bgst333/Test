...
int CMainWindow::OnFileSave(WPARAM wParam, LPARAM lParam) {
	...
	// "test.txt"にファイル出力.
	print_file_text_cstdio("test.txt", pszBuf);	// print_file_text_cstdioでpszBufを"test.txt"に出力.
...
int CMainWindow::OnFileOpen(WPARAM wParam, LPARAM lParam) {
	...
	MessageBox(NULL, pwszFileSize, _T("file_utility_cstdio"), MB_OK);	// MessageBoxでpwszFileSizeを表示.
