...
int CMainWindow::OnCreate(HWND hwnd, LPCREATESTRUCT lpCreateStruct){
	...
	m_pEdit->Create(_T("Edit1"), WS_BORDER, 50, 50, 100, 100, hwnd, (HMENU)(WM_APP + 1), lpCreateStruct->hInstance);	// Createでエディットコアコントロール"Edit1"のウィンドウ作成.
...
int CMainWindow::OnItem1_1(WPARAM wParam, LPARAM lParam){
	...
	// メッセージボックスを表示.
	MessageBox(NULL, _T("Item1-1"), _T("CEditCore"), MB_OK);	// MessageBoxで"Item1-1"と表示.
