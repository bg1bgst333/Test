...
BOOL InitInstance(HINSTANCE hInstance, LPTSTR lpCmdLine, int nShowCmd){
	...
	wc.lpszClassName = _T("Run");	// ウィンドウクラス名はとりあえず"Run"とする.
	...
	// ウィンドウの作成
	hWnd = CreateWindow(wc.lpszClassName, _T("Run"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance, NULL);	// CreateWindowでウィンドウクラス名が"Run"なウィンドウ"Run"を作成.
