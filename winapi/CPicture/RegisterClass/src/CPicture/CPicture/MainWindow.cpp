...
int CMainWindow::OnCreate(HWND hwnd, LPCREATESTRUCT lpCreateStruct){
	...
	m_pPicture->Create(_T("CPicture"), _T("CPicture"), WS_BORDER | WS_VSCROLL | SS_BITMAP, 50, 50, 400, 300, hwnd, (HMENU)(WM_APP + 1), lpCreateStruct->hInstance);	// Createでピクチャーコントロールのウィンドウ作成.
