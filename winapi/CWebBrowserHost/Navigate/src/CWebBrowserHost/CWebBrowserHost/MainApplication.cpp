...
BOOL CMainApplication::InitInstance(HINSTANCE hInstance, LPTSTR lpCmdLine, int nShowCmd) {
	...
	// ウィンドウクラスの登録.
	CMainWindow::RegisterClass(hInstance, NULL, WHITE_BRUSH);
	...
	// ウィンドウの作成.
	if (!m_pMainWnd->Create(_T("CWebBrowserHost"), WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, CW_USEDEFAULT, NULL, NULL, hInstance)) {	// m_pMainWnd->Createでウィンドウ作成し, 失敗した場合.
