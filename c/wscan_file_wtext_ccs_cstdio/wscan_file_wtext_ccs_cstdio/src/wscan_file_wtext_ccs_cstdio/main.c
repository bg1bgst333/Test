...
int main(void){
  ...
  wscan_file_wtext_ccs_cstdio("test1.txt", buf1, "UTF-8"); /* wscan_file_wtext_ccs_cstdioで"UTF-8"の"test1.txt"を読み込み. */
  ...
  wscan_file_wtext_ccs_cstdio("test2.txt", buf2, "EUC-JP"); /* wscan_file_wtext_ccs_cstdioで"EUC-JP"の"test2.txt"を読み込み. */
