...
int scan_file_wtext_locale_cstdio(const char *path, wchar_t *wtext, const char *locale); /* 関数scan_file_wtext_locale_cstdioの宣言. */
...
int main(void){
  ...
  scan_file_wtext_locale_cstdio("test1.txt", buf1, "ja_JP.UTF-8"); /* scan_file_wtext_locale_cstdioで"ja_JP.UTF-8"の"test1.txt"を読み込み. */
  ...
  scan_file_wtext_locale_cstdio("test2.txt", buf2, "ja_JP.EUC-JP"); /* scan_file_wtext_locale_cstdioで"ja_JP.EUC-JP"の"test2.txt"を読み込み. */
...
int scan_file_wtext_locale_cstdio(const char *path, wchar_t *wtext, const char *locale){
