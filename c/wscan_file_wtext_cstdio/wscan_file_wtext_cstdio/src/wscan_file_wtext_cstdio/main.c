...
int wscan_file_wtext_cstdio(const char *path, wchar_t *wtext); /* 関数wscan_file_wtext_cstdioの宣言. */
...
int main(void){
  ...
  wscan_file_wtext_cstdio("test1.txt", buf0); /* wscan_file_wtext_cstdioで"test1.txt"を読み込み. */
  ...
  wscan_file_wtext_cstdio("test1.txt", buf1); /* wscan_file_wtext_cstdioで"test1.txt"を読み込み. */
  ...
  wscan_file_wtext_cstdio("test2.txt", buf2); /* wscan_file_wtext_cstdioで"test2.txt"を読み込み. */
...
int wscan_file_wtext_cstdio(const char *path, wchar_t *wtext){
