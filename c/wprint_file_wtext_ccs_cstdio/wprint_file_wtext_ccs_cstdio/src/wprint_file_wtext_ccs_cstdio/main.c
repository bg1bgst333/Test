...
int main(void){
  ...
  wprint_file_wtext_ccs_cstdio("test1.txt", japanese_wstr, "UTF-8"); /* wprint_file_wtext_ccs_cstdioでjapanese_wstrを"UTF-8"で"test1.txt"に出力. */

  /* japanese_wstrを"EUC-JP"で"test2.txt"に出力. */
  wprint_file_wtext_ccs_cstdio("test2.txt", japanese_wstr, "EUC-JP"); /* wprint_file_wtext_ccs_cstdioでjapanese_wstrを"EUC-JP"で"test2.txt"に出力. */
