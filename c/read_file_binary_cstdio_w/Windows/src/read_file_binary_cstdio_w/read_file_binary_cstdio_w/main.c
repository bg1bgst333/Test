...
int main(void) {
	...
	ret1 = read_file_binary_cstdio_w(L"test1.txt", buf1, file_size_1 + 1);	/* read_file_binary_cstdio_wで"test1.txt"を読み込み. */
	...
	ret2 = read_file_binary_cstdio_w(L"test2.txt", buf2, file_size_2 + 1);	/* read_file_binary_cstdio_wで"test2.txt"を読み込み. */
