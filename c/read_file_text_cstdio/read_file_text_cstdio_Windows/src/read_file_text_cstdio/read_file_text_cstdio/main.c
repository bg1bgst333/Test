...
int main(void) {
	...
	ret1 = read_file_text_cstdio("test1.txt", buf1, file_size_1 + 1);	/* read_file_text_cstdioで"test1.txt"を読み込み. */
	...
	ret2 = read_file_text_cstdio("test2.txt", buf2, file_size_2 + 1);	/* read_file_text_cstdioで"test2.txt"を読み込み. */
