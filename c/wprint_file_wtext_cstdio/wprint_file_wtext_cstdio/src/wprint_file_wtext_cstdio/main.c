...
/* 関数のプロトタイプ宣言 */
int wprint_file_wtext_cstdio(const char *path, const wchar_t *wtext); /* 関数wprint_file_wtext_cstdioの宣言. */
...
int main(void){
  ...
  wprint_file_wtext_cstdio("test1.txt", japanese_wstr); /* wprint_file_wtext_cstdioでjapanese_wstrを"test1.txt"に出力. */

  /* ロケール"ja_JP.UTF-8"のセット. */
  setlocale(LC_ALL, "ja_JP.UTF-8"); /* setlocaleでLC_ALL, "ja_JP.UTF-8"をセット. */

  /* japanese_wstrを"test2.txt"に出力. */
  wprint_file_wtext_cstdio("test2.txt", japanese_wstr); /* wprint_file_wtext_cstdioでjapanese_wstrを"test2.txt"に出力. */

  /* ロケール"ja_JP.EUC-JP"のセット. */
  setlocale(LC_ALL, "ja_JP.EUC-JP"); /* setlocaleでLC_ALL, "ja_JP.EUC-JP"をセット. */

  /* japanese_wstrを"test3.txt"に出力. */
  wprint_file_wtext_cstdio("test3.txt", japanese_wstr); /* wprint_file_wtext_cstdioでjapanese_wstrを"test3.txt"に出力. */
...
int wprint_file_wtext_cstdio(const char *path, const wchar_t *wtext){
