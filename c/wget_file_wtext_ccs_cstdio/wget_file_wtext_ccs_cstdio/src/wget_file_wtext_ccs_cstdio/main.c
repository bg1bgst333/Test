...
int main(void){
  ...
  wget_file_wtext_ccs_cstdio("test1.txt", buf1, file_size_1 + 1, "UTF-8"); /* wget_file_wtext_ccs_cstdioで"UTF-8"の"test1.txt"を読み込み. */
  ...
  wget_file_wtext_ccs_cstdio("test2.txt", buf2, file_size_2 + 1, "EUC-JP"); /* wget_file_wtext_ccs_cstdioで"EUC-JP"の"test2.txt"を読み込み. */
