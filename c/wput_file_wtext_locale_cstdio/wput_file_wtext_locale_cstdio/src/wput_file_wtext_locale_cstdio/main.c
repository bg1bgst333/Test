...
/* 関数のプロトタイプ宣言 */
int wput_file_wtext_locale_cstdio(const char *path, const wchar_t *wtext, const char *locale); /* 関数wput_file_wtext_locale_cstdioの宣言. */
...
int main(void){
  ...
  wput_file_wtext_locale_cstdio("test1.txt", japanese_wstr, "ja_JP.UTF-8"); /* wput_file_wtext_locale_cstdioでjapanese_wstrを"ja_JP.UTF-8"で"test1.txt"に出力. */

  /* japanese_wstrを"test2.txt"に出力. */
  wput_file_wtext_locale_cstdio("test2.txt", japanese_wstr, "ja_JP.EUC-JP"); /* wput_file_wtext_locale_cstdioでjapanese_wstrを"ja_JP.EUC-JP"で"test2.txt"に出力. */
...
int wput_file_wtext_locale_cstdio(const char *path, const wchar_t *wtext, const char *locale){
